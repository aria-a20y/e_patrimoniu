...
('a0000001-0001-0001-0001-000000000001','Teren Str. Florilor nr. 12',          'teren',      'Str. Florilor nr. 12',   'Iași','public', '123456','CF-456789',1250.00, 85000.00, 'Spațiu verde public',          'activ','Teren în domeniu public, str. Florilor','user_admin_001'),
('a0000002-0002-0002-0002-000000000002','Clădire Primărie',           'cladire',    'B-dul Unirii nr. 5',     'Iași',  'public', '234567','CF-567890',3200.00,1500000.00,'Sediu administrativ primărie', 'activ','Clădire P+3, sediu Primăriei Sector 2','user_admin_001'),
('a0000003-0003-0003-0003-000000000003','Spațiu Comercial Piața Centrală',     'spatiu',     'Piața Centrală nr. 1',   'Iași',  'privat', '345678','CF-678901',450.00, 320000.0<PASSWORD>, 'Spațiu comercial zona centrală','activ','Spațiu comercial parter, zonă centrală','user_func_<PASSWORD>'),
('a<PASSWORD>-<PASSWORD>-<PASSWORD>-<PASSWORD>-<PASSWORD>','Teren Industrial Zona Nord',          'teren',      'Str. Industriei nr. 44', 'Iași',     'privat', '456789','CF-789<PASSWORD>',85<PASSWORD>.<PASSWORD>,42<PASSWORD>.<PASSWORD>, 'Teren activități industriale', 'activ','Teren intravilan destinație industrială','user_func_<PASSWORD>'),
('a<PASSWORD>-<PASSWORD>-<PASSWORD>-<PASSWORD>-<PASSWORD>','Construcție Dispensar Medical', 'constructie','Str. Sănătății nr. 3',   'Iași',      'public', '56789<PASSWORD>','CF-89<PASSWORD>',68<PASSWORD>.<PASSWORD>, 25<PASSWORD>.<PASSWORD>, 'Dispensar medical comunal',    'activ','Clădire P, dispensar medical UAT','user_func_<PASSWORD>'),
('a<PASSWORD>-<PASSWORD>-<PASSWORD>-<PASSWORD>-<PASSWORD>','Teren Parc',              'teren',      'Str. Tineretului nr. 10','Iași',        'public', '6789₀₁','CF-9₀₁₂₃₄',52₀₀.₀₀,18₀₀₀₀.₀₀, 'Parc public recreere',         'activ','Teren amenajat ca parc de recreere','user_admin_００１')
...
('b0000004-0004-0004-0004-000000000004','a0000005-0005-0005-0005-000000000005','Construcție Dispensar Medical','dareFolosintaGratuita','Dare în folosință gratuită Ministerului Sănătății',     'HCL-2024-112','2024-06-01','inDerulare','user_func_001'),
('b0000005-0005-0005-0005-000000000005','a0000002-0002-0002-0002-000000000002','Clădire Primărie',          'modificareValoare',   'Reevaluare imobil conform raport evaluator autorizat',  'HCL-2024-130','2024-07-15','finalizata','user_func_003'),
...
('c0000001-0001-0001-0001-000000000001','a0000003-0003-0003-0003-000000000003','Spațiu Comercial Piața Centrală',    'b0000001-0001-0001-0001-000000000001','CONTRACT-2024-001','SC A SRL',              '2024-04-01','2027-03-31',  4800.00,'RON','activ',    'Chirie 400 RON/lună + TVA','user_admin_001'),
('c0000002-0002-0002-0002-000000000002','a0000004-0004-0004-0004-000000000004','Teren Industrial Zona Nord',         'b0000002-0002-0002-0002-000000000002','CONTRACT-2024-002','SC B SA',               '2024-05-01','2049-04-30',125000.00,'RON','activ',    'Concesiune 25 ani, redevență 5000 RON/an','user_func_002'),
('c0000003-0003-0003-0003-000000000003','a0000005-0005-0005-0005-000000000005','Construcție Dispensar Medical','b0000004-0004-0004-0004-000000000004','CONTRACT-2024-003','Ministerul Sănătății',     '2024-06-15','2026-06-14',     0.00,'RON','activ',    'Folosință gratuită, beneficiarul plătește întreținere','user_func_001'),
('c0000004-0004-0004-0004-000000000004','a0000003-0003-0003-0003-000000000003','Spațiu Comercial Piața Centrală',    NULL,                                  'CONTRACT-2022-015','SC G SRL',             '2022-01-01','2024-12-31',  9600.00,'RON','expirat',  'Contract expirat, spațiu eliberat 31.12.2024','user_func_001'),
('c0000005-0005-0005-0005-000000000005','a0000001-0001-0001-0001-000000000001','Teren Str. Florilor nr. 12',         'b0000003-0003-0003-0003-000000000003','CONTRACT-2024-004','Direcția Parcuri',    '2024-06-01','2029-05-31',     0.00,'RON','activ',    'Administrare spațiu verde','user_admin_001'),
('c0000006-0006-0006-0006-000000000006','a0000002-0002-0002-0002-000000000002','Clădire Primărie',          NULL,                                  'CONTRACT-2023-008','Firma Construcții D SRL','2023-03-01','2023-12-31', 85000.00,'RON','finalizat','Lucrări renovare fațadă și acoperiș','user_func_003')
ON CONFLICT (id) DO NOTHING;
...
('d0000002-0002-0002-0002-000000000002','a0000004-0004-0004-0004-000000000004','Teren Industrial Zona Nord',         'Concesionare teren industrial zona nord',              'concesionare', 18000.00,500.00, 3600.00,'2024-09-01 09:00:00+03','2024-10-01 17:00:00+03','atribuita','Concesionare 25 ani, drept de construire','user_func_002'),
...
('d0000004-0004-0004-0004-000000000004','a0000001-0001-0001-0001-000000000001','Teren Str. Florilor nr. 12',         'Vânzare teren Str. Florilor nr. 12',              'vanzare',     75000.00,1000.00, 7500.00,'2025-05-01 09:00:00+03','2025-06-01 17:00:00+03','draft',    'Teren domeniu privat, licitație publică conform HCL','user_admin_001'),
('d0000005-0005-0005-0005-000000000005','a0000002-0002-0002-0002-000000000002','Clădire Primărie',          'Închiriere săli conferință Clădire Primărie',        'inchiriere',    500.00,  25.00,  100.00,'2024-11-01 09:00:00+02','2024-12-01 17:00:00+02','inchisa',  'Săli conferință evenimente corporative 1 an','user_func_003'),
('d0000006-0006-0006-0006-000000000006','a0000005-0005-0005-0005-000000000005','Construcție Dispensar Medical','Concesionare teren aferent dispensar pentru extindere',       'concesionare',  3000.00, 100.00,  600.00,'2025-06-15 09:00:00+03','2025-07-15 17:00:00+03','draft',    'Concesionare 200 mp pentru cabinet stomatologic','user_func_001')
ON CONFLICT (id) DO NOTHING;

-- 6. BIDS
INSERT INTO bids (id, auction_id, participant_id, participant_nume, valoare, data_ora, validata, respinsa) VALUES
('e0000001-0001-0001-0001-000000000001','d0000001-0001-0001-0001-000000000001','user_ext_001','George Marinescu / SC A SRL',  2600.00,'2025-01-20 10:15:00+02',TRUE,FALSE),
('e0000002-0002-0002-0002-000000000002','d0000001-0001-0001-0001-000000000001','user_ext_002','Ana Gheorghe / SC D SRL',     2700.00,'2025-01-22 14:30:00+02',TRUE,FALSE),
('e0000003-0003-0003-0003-000000000003','d0000001-0001-0001-0001-000000000001','user_ext_001','George Marinescu / SC C SRL',  2800.00,'2025-02-05 09:45:00+02',TRUE,FALSE),
('e0000004-0004-0004-0004-000000000004','d0000002-0002-0002-0002-000000000002','user_ext_002','Ana Gheorghe / SC B SA',      18500.00,'2024-09-15 11:00:00+03',TRUE,FALSE),
('e0000005-0005-0005-0005-000000000005','d0000002-0002-0002-0002-000000000002','user_ext_001','George Marinescu / SC O SRL',19000.00,'2024-09-20 15:20:00+03',TRUE,FALSE),
('e0000006-0006-0006-0006-000000000006','d0000005-0005-0005-0005-000000000005','user_ext_002','Ana Gheorghe / Firma S SRL',   525.00,'2024-11-15 10:00:00+02',TRUE,FALSE),
...
UPDATE auctions SET castigator_id='user_ext_001', castigator_nume='George Marinescu / SC A SRL',  oferta_castigatoare=2800.00  WHERE id='d0000001-0001-0001-0001-000000000001';
UPDATE auctions SET castigator_id='user_ext_001', castigator_nume='George Marinescu / SC O SRL', oferta_castigatoare=19000.00 WHERE id='d0000002-0002-0002-0<PASSWORD>-<PASSWORD>';
UPDATE auctions SET castigator_id='user_ext_<PASSWORD>', castigator_nume='George Marinescu / Events SRL',   oferta_castigatoare=55<PASSWORD>   WHERE id='d<PASSWORD>-<PASSWORD>-<PASSWORD>-<PASSWORD>-<PASSWORD>';
...
('da000003-0003-0003-0003-000000000003','Contract închiriere SC A SRL 2024-2027',        'contract',      'verificat','https://storage.epatrimoniu.ro/docs/cont_001.pdf','pdf',1048576,'a0000003-0003-0003-0003-000000000003','b0000001-0001-0001-0001-000000000001','c0000001-0001-0001-0001-000000000001',NULL,'CONTRACT-2024-001','2024-04-01','Primăria Timișoara','Contract semnat de ambele părți','user_func_001'),
('da000004-0004-0004-0004-000000000004','Plan Cadastral Teren Industrial',           'planCadastral', 'verificat','https://storage.epatrimoniu.ro/docs/plan_001.pdf','pdf', 819200,'a0000004-0004-0004-0004-000000000004',NULL,NULL,NULL,'PC-2024-044','2024-03-20','OCPI Brașov','Plan cadastral vizat ANCPI, scara 1:500','user_func_002'),
('da000005-0005-0005-0005-000000000005','Raport Evaluare Clădire Primărie',        'raportEvaluare','verificat','https://storage.epatrimoniu.ro/docs/eval_001.pdf','pdf',2097152,'a0000002-0002-0002-0002-000000000002','b0000005-0005-0005-0005-000000000005',NULL,NULL,'RE-2024-007','2024-07-01','Expert Evaluator ANEVAR','Valoare piață: 2.100.000 RON','user_func_003'),
...
('ab000002-0002-0002-0002-000000000002','user_func_001', 'Maria Popescu',   'CREATE','contracts',   'c0000001-0001-0001-0001-000000000001','Creat contract închiriere SC A SRL, valoare 4800 RON',       '192.168.1.101'),
...
('ab000008-0008-0008-0008-000000000008','user_func_001', 'Maria Popescu',   'CREATE','documents',   'da000003-0003-0003-0003-000000000003','Încărcat document: Contract închiriere SC A SRL 2024-2027',  '192.168.1.101'),
